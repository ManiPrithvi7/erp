...
methods.create = async (req: AuthenticatedRequest, res: Response) => {
...
methods.delete = async (req: AuthenticatedRequest, res: Response) => {
...
methods.update = async (req: AuthenticatedRequest, res: Response) => {
  const { id } = req.params;
