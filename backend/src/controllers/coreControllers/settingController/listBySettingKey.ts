...
const listBySettingKey = async (req: AuthenticatedRequest, res: Response) => {
  // Find document by id

  const settingKeyArray = req.query.settingKeyArray ? (req.query.settingKeyArray as string).split(',') : [];
